...
- [Detailed Design](#detailed-design)
  ...
  - [Skill Descriptions](#skill-descriptions)
    - [scaffold — Create new category or blueprint](#scaffold--create-new-category-or-blueprint)
    - [add-template — Add template files to a blueprint](#add-template--add-template-files-to-a-blueprint)
    - [update-blueprint — Modify blueprint.yaml](#update-blueprint--modify-blueprintyaml)
    - [bump-version — Version management](#bump-version--version-management)
    - [list — Enumerate blueprints](#list--enumerate-blueprints)
    - [validate — Lint and validate](#validate--lint-and-validate)
  - [Reference Files](#reference-files)
    - [blueprint-schema.md](#blueprint-schemamd)
    - [conventions.md](#conventionsmd)
  - [Registry Reviewer Agent](#registry-reviewer-agent)
