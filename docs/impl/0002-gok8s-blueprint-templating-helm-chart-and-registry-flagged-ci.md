...
- [Open Questions](#open-questions)
  - [1. Variable syntax: forge v0.8 removes the legacy forms](#1-variable-syntax-forge-v08-removes-the-legacy-forms)
  - [2. Inherited variable surface (Backstage / git-provider vars)](#2-inherited-variable-surface-backstage--git-provider-vars)
  - [3. How helm.just (and docker.just) join the main justfile](#3-how-helmjust-and-dockerjust-join-the-main-justfile)
  - [4. Inherited release/changelog workflow reconciliation](#4-inherited-releasechangelog-workflow-reconciliation)
  - [5. Workflow generalization: GitHub-context vs forge-templating](#5-workflow-generalization-github-context-vs-forge-templating)
